    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string simpleJoin = Kusto.New().AzureActivity
                .Where((tbl, col) => tbl.SourceSystem.In("A", "B", "BC", "DE"))
            ...
            string multi_conditions_string_operators =
                Kusto.New().Update.Where((tbl, col) =>
            ...
            string complexExtensions = Kusto.New().Update
                ...
                .Where((tbl, col) => tbl.TimeGenerated > Kql.ago("12h"))
                .Project((tbl, col) => new {
