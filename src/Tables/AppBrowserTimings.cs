...
{
    public class AppBrowserTimings : TableBase<AppBrowserTimings>
    {
            ...
            public float NetworkDurationMs {get; set;}
            
            /// Send request time in milliseconds.
            public float SendDurationMs {get; set;}
            
            /// Page load recieve response duration in milliseconds.
            public float ReceiveDurationMs {get; set;}
            
            /// Page DOM processing time in milliseconds.
            public float ProcessingDurationMs {get; set;}
