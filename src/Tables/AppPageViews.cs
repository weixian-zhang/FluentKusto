...
{
    public class AppPageViews : TableBase<AppPageViews>
    {

            /// 
            public string TenantId {get; set;}
            
            /// Date and time when page view was recorded.
            public DateTime TimeGenerated {get; set;}
            
            /// Application-generated, unique page view ID.
            public string Id {get; set;}
            
            /// Human-readable name of the page view.
            public string Name {get; set;}
            
            /// URL of the page view.
            public string Url {get; set;}
            
            /// Number of milliseconds it took the application to handle the page view.
