...
{
    public class MCCEventLogs : TableBase<MCCEventLogs>
    {
            ...
            public float HitRatioMbps {get; set;}
            ...
            public float EgressMbps {get; set;}
