...
{
    public class AppTraces : TableBase<AppTraces>
    {

            /// 
            public string TenantId {get; set;}
            
            /// Date and time when trace was recorded.
            public DateTime TimeGenerated {get; set;}
            
            /// Trace message.
            public string Message {get; set;}
            
            /// Severity level of the trace.
            ...
            /// Id of the item with additional details about the trace.
            public string ReferencedItemId {get; set;}
            
            /// Name of the table with additional details about the trace.
