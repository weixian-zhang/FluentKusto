...
{
    public class AmlDataLabelEvent : TableBase<AmlDataLabelEvent>
    {
            ...
            public string AmlProjectId {get; set;}
            
            /// The name of the AML project.
            public string AmlProjectName {get; set;}
            
            /// The AAD tenant ID the operation was submitted for.
            public string AadTenantId {get; set;}
            
            /// The label class names which are created for the project.
            public string AmlLabelNames {get; set;}
            
            /// The name of the data store where the project's data is stored.
