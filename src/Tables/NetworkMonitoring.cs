...
{
    public class NetworkMonitoring : TableBase<NetworkMonitoring>
    {
            ...
            /// 
            public float HighLatency {get; set;}
            
            /// 
            public float MedianLatency {get; set;}
            
            /// 
            public float LowLatency {get; set;}
            ...
            /// 
            public float LossBenchmark {get; set;}
            
            /// 
            public float LatencyBenchmark {get; set;}
            ...
            /// 
            public float LossThreshold {get; set;}
            
            /// 
            public float LatencyThreshold {get; set;}
            ...
            /// 
            public float ServiceResponseTime {get; set;}
            
            /// 
            public string ServiceResponseHealthState {get; set;}
            
            /// 
            public float ServiceResponseThreshold {get; set;}
            
            /// 
            public string ServiceResponseThresholdMode {get; set;}
            
            /// 
            public float ServiceLossPercent {get; set;}
            ...
            /// 
            public float PingDelayInMsec {get; set;}
