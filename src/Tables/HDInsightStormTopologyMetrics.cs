...
{
    public class HDInsightStormTopologyMetrics
    {
        ...
        public real Acked {get; set;}
        
        ///Percent of CPU cores assigned to the topology.
        public real AssignedCPUPercent {get; set;}
        
        ///MB of off heap memory assigned to the topology.
        public real AssignedMemOffHeapMB {get; set;}
        
        ///MB of on heap memory assigned to the topology.
        public real AssignedMemOnHeapMB {get; set;}
        
        ///MB of total memory assigned to the topology.
        public real AssignedTotalMemMB {get; set;}
        ...
        public real CompleteLatencyMs {get; set;}
        ...
        public real ExecuteLatencyMs {get; set;}
        ...
        public real MsgTimeout {get; set;}
        ...
        public real ProcessLatencyMs {get; set;}
        ...
        public real RequestedCpuPercent {get; set;}
        
        ///MB of off heap memory requested by the topology.
        public real RequestMemOffHeapMB {get; set;}
        
        ///MB of on heap memory requested by the topology.
        public real RequestMemOnHeapMB {get; set;}
        
        ///Percentage of messages sampled to calculate metrics.
        public real SamplingPct {get; set;}
