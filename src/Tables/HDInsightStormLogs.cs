...
{
    public class HDInsightStormLogs : TableBase<HDInsightStormLogs>
    {
            ...
            /// The name of the log file that a record came from (e.g. StormNimbus, StormSupervisor).
            public string LogType {get; set;}
            
            /// The severity level of the log (e.g. INFO,WARN, ERROR, etc.)
