...
{
    public class HDInsightHadoopAndYarnLogs : TableBase<HDInsightHadoopAndYarnLogs>
    {
            ...
            /// message from Hadoop or YARN log.
            ...
            /// The name of the log file that a record came from (e.g. YarnTimeLineServer, YarnResourceManager, etc.).
