...
{
    public class CDBGremlinRequests
    {

        ///
        public string TenantId {get; set;}
        
        ///Timestamp (in UTC) when this Graph API operation was executed on the server.
        public datetime TimeGenerated {get; set;}
        
        ///The name of the Cosmos DB account against�which this request was issued.
        public string AccountName {get; set;}
        
        ///The name of the Gremlin�operation that�was�executed.
        ...
        ///The IP address of the client, which�issued this request.
        public string Address {get; set;}
        
        ///Full query with parameters (if opted in) for this request.
        ...
        ///The unique identifier (GUID) for this Graph API request.
