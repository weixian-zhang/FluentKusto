...
{
    public class MicrosoftDynamicsTelemetryPerformanceLogs
    {
        ...
        public real ExecutionTimeSeconds {get; set;}
        ...
        public real TransactionDurationSeconds {get; set;}
