...
namespace FluentKusto
{
    public class StorageFileLogs
    {
        ...
        public real ServerLatencyMs {get; set;}
        ...
        public string SmbPrimarySID {get; set;}
        ...
        public string SmbTreeConnectID {get; set;}
        ...
        public string SmbPersistentHandleID {get; set;}
